...
port_scan = defalut_med_port_scan
...
alert_json = {
    file = true,                            -- CRITICAL: Forces output to a file instead of stdout
    limit = 100,                            -- Optional: File size limit in MB (adjust as needed)
    fields = 'timestamp action class msg src_addr src_port dst_addr dst_port proto sid rev',
    -- Note: The logger usually creates the file: /var/log/snort/alert_json.txt
}
